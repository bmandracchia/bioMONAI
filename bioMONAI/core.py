...
# %% auto 0
__all__ = ['fastTrainer', 'visionTrainer', 'compute_losses', 'compute_metric', 'calculate_statistics', 'format_sig',
           'plot_histogram_and_kde', 'display_statistics_table', 'evaluate_model', 'evaluate_classification_model',
           'attributesFromDict', 'get_device', 'img2float', 'img2Tensor']
...
def plot_histogram_and_kde(data, stats, bw_method, fn_name):
    """
