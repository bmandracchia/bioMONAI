...
# %% auto 0
__all__ = ['tiff2torch', 'aics_image_reader', 'hdf5_reader', 'img_reader']
...
# %% ../nbs/02_io.ipynb 10
def hdf5_reader(path, # The path to the HDF5 file to be read
              dataset=None, # The dataset to load
              patch=0, # The patch to load from the dataset
              ext='.h5' # Filename extension 
              ):
...
def _load_and_preprocess(file_path, # Image file path
                         ...
                         reader=aics_image_reader # Image reader
                        ):
    """
