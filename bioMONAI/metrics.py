...
# %% auto 0
__all__ = ['SSIMMetric', 'radial_mask', 'get_radial_masks', 'get_fourier_ring_correlations', 'FRCMetric']
...
def SSIMMetric(x, y, spatial_dims=2):
    ssimloss = SSIMLoss(spatial_dims)(x,y)
    return LossMetric(loss_fn=ssimloss)
